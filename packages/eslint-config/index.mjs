 ...
 * @param {string} [options.tsconfigPath] tsconfig used by the import resolver,
 *   relative to the consuming workspace.
 * @param {string[]} [options.componentGlobs] files that must use named exports.
 * @param {boolean} [options.withNext] enable the @next/next rules; turn it off
 *   for packages that are not Next.js apps.
 * @param {import('eslint').Linter.Config[]} [options.extra] extra flat configs
